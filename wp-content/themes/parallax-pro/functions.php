...
genesis_register_sidebar( array(
	'id'          => 'home-section-2-5',
	'name'        => __( 'Home Section 2-5', 'parallax-pro' ),
	'description' => __( 'This is the home section 2-5 section.', 'parallax-pro' ),
) );
genesis_register_sidebar( array(
	'id'          => 'home-section-3',
...
genesis_register_sidebar( array(
	'id'          => 'home-section-4-5',
	'name'        => __( 'Home Section 4-5', 'parallax-pro' ),
	'description' => __( 'This is the home section 4-5 section.', 'parallax-pro' ),
) );
genesis_register_sidebar( array(
	'id'          => 'home-section-5',
